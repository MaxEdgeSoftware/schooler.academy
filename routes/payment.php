...
Route::post('paystack/subscribe', [PaystackController::class, 'redirectSubscribeToGateway'])->name('paystack.subscribe');
Route::get('/subscribe/success', [PaystackController::class, 'successSubscribe'])->name('subscribe.success');
